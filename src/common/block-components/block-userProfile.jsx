...
const Heading = lazy(() => import("../abstract-components/profileHeading"));
const AuthForm = lazy(async () => ({
	default: (await import("../profileForm")).AuthForm,
}));
const PersonalForm = lazy(async () => ({
	default: (await import("../profileForm")).PersonalForm,
}));
const DateInput = lazy(async () => ({
	default: (await import("../input")).DateInput,
}));
